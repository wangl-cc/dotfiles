...
| Submit or follow up | `POST /sessions/{id}/prompts` with `prompt_id`, `content`, `permission_mode: "yolo"`, and optional `profile`, `model`, `thinking` |

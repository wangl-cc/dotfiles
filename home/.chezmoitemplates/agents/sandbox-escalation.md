...
- If a command fails because of a likely sandbox, permission, or network restriction, retry the same intended command with escalation rather than silently substituting a workaround.
